...
export default function ProjectorScreen({ token }: { token: string }) {
  ...
  if (!payload.name || !payload.childhoodImageUrl || !graduationUrl) return <main className="projector-stage"><div className="projector-status">الصورة غير مكتملة لهذا الخريج</div></main>;
